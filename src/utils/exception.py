...
class PMException(Exception):
    ...
    """
    PMException is customized exception designed to capture refined details about exception
    ...
    def __init__(self, error_message :Exception, error_detail:sys):
        ...
        self.error_message = PMException.error_message_detail(error_message,error_detail=error_detail)
    ...
    def __repr__(self):
        ...
        """
        formating object of PMException
        """
        return PMException.__name__.__str__()
